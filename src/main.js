...
function analyzeSalesData(data, options) {
    ...
    const sellerIndex = Object.fromEntries(sellerStats.map(i => [i.id, i]));
    const productIndex = Object.fromEntries(data.products.map(i => [i.sku, i]));
    ...
    data.purchase_records.forEach(record => { // Чек 
        ...
        record.items.forEach(item => {
            ...
            const seb = product.purchase_price * item.quantity
